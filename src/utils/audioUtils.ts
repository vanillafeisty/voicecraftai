...
export const VOICE_OPTIONS: VoiceOption[] = [
  {
    ...
    description: 'Natural, articulate, and warm with expressive Indian pacing.',
    styleTag: 'Warm & Articulate',
  },
  {
    id: 'Deepa',
    name: 'Deepa',
    ...
    region: 'Indian',
    accent: 'Indian English',
    description: 'Gentle, clear, and soothing tone for explanations and audiobooks.',
  ...
  },
  {
    ...
    region: 'Indian',
    accent: 'Indian English',
    description: 'Confident, clear, and resonant voice suitable for presentations.',
  ...
  },
  {
    ...
    region: 'International',
    accent: 'International English',
    description: 'Bright, friendly, and natural conversational international voice.',
    styleTag: 'Natural & Expressive',
  },
  {
    id: 'Fenrir',
    name: 'Fenrir',
    ...
    region: 'International',
    accent: 'International English',
    description: 'Deep, steady, and authoritative voice with rich acoustic timbre.',
  ...
  },
  {
    ...
    region: 'International',
    accent: 'International English',
    description: 'Polished, classic broadcaster baritone for narrations and intros.',
    styleTag: 'Classic Broadcast',
  },
];
